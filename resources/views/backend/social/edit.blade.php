    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation" method="POST" action="{{ route('socialIcons.update', $socialLink->id) }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="key" id="key"
                                                    placeholder="Title here" value="{{ old('key', $socialLink->key) }}" required
                                                    onkeyup="myFunction();" />
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="link" id="link"
                                                    placeholder="Slug" value="{{ old('link', $socialLink->link) }}" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <div class="mb-3">
                                                    ...
                                                    placeholder="Enter Class Name" value="{{ old('Class', $socialLink->class) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" value="1" min="0" class="form-control"
                                                    ...
                                                    value="{{ old('order', $socialLink->order) }}" required>
                                                <div class="invalid-feedback">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <h6>current image</h6>
                                        <img src="{{ asset('assets/frontend/images/social-icons/'. $socialLink->icon) }}" class="img-thumbnail" style="width:100px" alt="no-image">
