    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation" method="POST" action="{{ route('banners.update', $banner->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="heading[one]"
                                                    id="heading_oneBrown" placeholder="Heading One"
                                                    value="{{ old('heading.one', @json_decode($banner->headings)->one) }}" />
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="heading[two]"
                                                    id="heading_two" placeholder="Heading Two here"
                                                    value="{{ old('heading.two', @json_decode($banner->headings)->two) }}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="description" id="description" placeholder="Description here">{{ old('description', @$banner->description) }}</textarea>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="buttons[title1]"
                                                    id="btn_title" placeholder="Button Title here"
                                                    value="{{ old('button.title1', @json_decode($banner->buttons)->title1) }}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="buttons[link1]"
                                                    id="btn_link" placeholder="Button Link here"
                                                    value="{{ old('buttons.link1', @json_decode($banner->buttons)->link1) }}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="buttons[title2]"
                                                    id="btn_title" placeholder="Button Title here"
                                                    value="{{ old('button.title2', @json_decode($banner->buttons)->title2) }}">
                                                <div class="invalid-feedback">
                                                    Please enter valid button title.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="buttons[link2]"
                                                    id="btn_link" placeholder="Button Link here"
                                                    value="{{ old('buttons.link2', @json_decode($banner->buttons)->link2) }}">
                                                <div class="invalid-feedback">
                                                    Please enter valid button link.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <label for="page" class="form-label">Page <i
                                                        class="text-danger">*</i></label>
                                                <select class="form-select select2" id="page_id" name="page_id"
                                                    required>
                                                    <option selected disabled value="">Select Page</option>
                                                    @forelse ($pages as $page)
                                                        <option value="{{ $page->id }}" {{ ($banner->page_id == $page->id) ? 'selected' : '' }}>{{ $page->name ?? '' }}
                                                        </option>
                                                    @empty
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Enter Valid Image Name" id="image_name"
                                                    name="image_name" value="{{ old('image_name', explode('.', $banner->image)[0]) }}" />
                                                <div class="invalid-feedback">
