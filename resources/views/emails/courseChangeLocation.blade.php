...
<body>
    ...
    <p>
        ...
        *Each registrant must bring examples of good and bad customer service experiences!
        ...
        <br />
        <b>Event Address : </b>{{ $data['event_address'] }}
        <br />
        <b>City : </b>{{ $data['event_city'] }}
        <br />
        <b>State : </b>{{ $data['event_state'] }}
        ...
        <br />
        <br />
        <img src="https://bottomlinebizsolutions.com/wp-content/uploads/2022/11/Logo_FF-1-2-1-2048x1046.png"
