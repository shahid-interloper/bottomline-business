$(function() {
    ...
    }), $("#inline-group").editable({ showbuttons: !1, mode: "inline", inputclass: "form-select form-select-sm" }), $("#inline-dob").editable({ mode: "inline", inputclass: "form-select form-select-sm" }), $("#inline-comments").editable({ showbuttons: "bottom", mode: "inline", inputclass: "form-control-sm" })
});