                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="phone" id="phone"
                                                    placeholder="Phone Here" value="{{ old('phone') }}" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control" name="password"
                                                    placeholder="Password Here" id="passwordInput"
                                                    value="{{ old('OriginalPassword') }}" required>
                                                <br />
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select select2" data-placeholder="Choose Roles"
                                                    multiple id="role" name="roles[]" required focus>
